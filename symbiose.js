    ...
    if (this.gamedatas.nbre_players == 2)
    {
        for( var player_id in this.gamedatas.new_ordre_players)   
        {
            ...
            Playercards.innerHTML = 
                        ...
                        <div id="cardposition_1_${player}" class="card_position" style="left: 0px; top: 30px;"></div>
                        <div id="cardposition_2_${player}" class="card_position" style="left: 160px; top: 30px;"></div>
                        <div id="cardposition_3_${player}" class="card_position" style="left: 320px; top: 30px;"></div>
                        <div id="cardposition_4_${player}" class="card_position" style="left: 480px; top: 30px;"></div>

                        <div id="cardposition_5_${player}" class="card_position" style="left: 0px; top: 265px;"></div>
                        <div id="cardposition_6_${player}" class="card_position" style="left: 160px; top: 265px;"></div>
                        <div id="cardposition_7_${player}" class="card_position" style="left: 320px; top: 265px;"></div>
                        <div id="cardposition_8_${player}" class="card_position" style="left: 480px; top: 265px;"></div>
                        `;
